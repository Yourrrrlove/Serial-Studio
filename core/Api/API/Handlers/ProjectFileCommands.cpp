 ...
 */
API::Handlers::ProjectFileCommands::ProjectFileCommands(CommandRegistry& registry)
  : m_registry(registry)
{}
 ...
 */
void API::Handlers::ProjectFileCommands::registerFileCommands()
{
 ...
 */
void API::Handlers::ProjectFileCommands::registerHistoryCommands()
{
 ...
 */
void API::Handlers::ProjectFileCommands::registerLifecycleCommands()
{
  auto& registry = m_registry;
 ...
 */
void API::Handlers::ProjectFileCommands::registerMetadataCommands()
{
  auto& registry   = m_registry;
  const auto empty = emptySchema();
...
/**
 * @brief Register the project.snapshot composite read.
 */
void API::Handlers::ProjectFileCommands::registerSnapshotCommand()
{
  auto& registry = m_registry;
 ...
 */
void API::Handlers::ProjectFileCommands::registerTemplateCommands()
{
  auto& registry = m_registry;
 ...
 */
API::CommandResponse API::Handlers::ProjectFileCommands::fileNew(const QString& id,
 ...
 */
API::CommandResponse API::Handlers::ProjectFileCommands::projectUndo(const QString& id,
                                                                     const QJsonObject& params)
{
  Q_UNUSED(params);
  auto& projectModel = DataModel::pipelineModules().projectModel;
 ...
 */
API::CommandResponse API::Handlers::ProjectFileCommands::projectRedo(const QString& id,
                                                                     const QJsonObject& params)
{
  Q_UNUSED(params);
  auto& projectModel = DataModel::pipelineModules().projectModel;
 ...
 */
API::CommandResponse API::Handlers::ProjectFileCommands::setTitle(const QString& id,
                                                                  const QJsonObject& params)
{
 ...
 */
API::CommandResponse API::Handlers::ProjectFileCommands::fileOpen(const QString& id,
                                                                  const QJsonObject& params)
{
 ...
 * @brief Save project
 */
API::CommandResponse API::Handlers::ProjectFileCommands::fileSave(const QString& id,
                                                                  const QJsonObject& params)
{
 ...
 */
API::CommandResponse API::Handlers::ProjectFileCommands::getStatus(const QString& id,
                                                                   const QJsonObject& params)
{
  Q_UNUSED(params)
 ...
 */
API::CommandResponse API::Handlers::ProjectFileCommands::projectSnapshot(const QString& id,
                                                                         const QJsonObject& params)
{
 ...
 */
API::CommandResponse API::Handlers::ProjectFileCommands::loadFromJSON(const QString& id,
                                                                      const QJsonObject& params)
{
 ...
 */
API::CommandResponse API::Handlers::ProjectFileCommands::exportJson(const QString& id,
                                                                    const QJsonObject& params)
{
  Q_UNUSED(params)
 ...
 */
API::CommandResponse API::Handlers::ProjectFileCommands::loadIntoFrameBuilder(
 ...
 */
API::CommandResponse API::Handlers::ProjectFileCommands::templateList(const QString& id,
                                                                      const QJsonObject& params)
{
  Q_UNUSED(params)
 ...
 */
API::CommandResponse API::Handlers::ProjectFileCommands::templateApply(const QString& id,
                                                                       const QJsonObject& params)
{
 ...
 */
API::CommandResponse API::Handlers::ProjectFileCommands::validate(const QString& id,
                                                                  const QJsonObject& params)
{
  Q_UNUSED(params)

  static const auto& project = DataModel::pipelineModules().projectModel;
