 ...
 */
void API::Handlers::ProjectApiSupport::appendDatasetWidgetTypes(const DataModel::Dataset& ds,
                                                                QJsonArray& compat)
{
 ...
 */
int API::Handlers::ProjectApiSupport::datasetOptionsBitflag(const DataModel::Dataset& ds)
{
 ...
 */
QJsonObject API::Handlers::ProjectApiSupport::buildDatasetObject(const DataModel::Dataset& dataset,
 ...
 *        project.
 */
API::Handlers::ProjectApiSupport::DatasetMatch API::Handlers::ProjectApiSupport::
  resolveDatasetSelector(const QJsonValue& selector, QString& error)
{
 ...
 *        offset".
 */
API::Handlers::ProjectApiSupport::ListWindow API::Handlers::ProjectApiSupport::applyWindow(
 ...
 *        full set.
 */
void API::Handlers::ProjectApiSupport::attachWindowInfo(QJsonObject& result,
 ...
 */
void API::Handlers::ProjectApiSupport::appendStaleProjectWarning(QJsonObject& result,
 ...
 */
QString API::Handlers::ProjectApiSupport::detectLanguageMismatch(const QString& code, int language)
{
