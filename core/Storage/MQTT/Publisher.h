...
#  include "Protocols/Tls/TlsConfig.h"
...
class Publisher
  ...
  , public IO::IRawFrameTap
  , public IO::IMqttPublisher {
  // clang-format off
  Q_OBJECT
...
public slots:
  ...
  void onRawFrame(int deviceId, const IO::CapturedDataPtr& frame) override;
  void onNotificationPosted(const Core::Bus::NotificationPosted& posted);

  [[nodiscard]] qint64 mqttPublish(const QString& topic,
