...
/**
 * @file DiagnosticsTypes.h
 * @brief The layer-neutral vocabulary of the connection diagnostics (spec 0035): the bus
 *        taxonomy, its scope mask, the verdict of one check and the result record. Devices maps a
 *        driver onto a Bus and publishes the open verdict over the message bus; Ui runs the checks
 *        and lowers results into problem-center findings (Misc/Diagnostics/DiagnosticsShared.h).
 */
